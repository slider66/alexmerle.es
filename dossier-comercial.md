...
Hace unos años, tener un sistema de reservas automático, una web posicionada en Google o un proceso de captación de clientes bien montado era cosa de empresas grandes con presupuestos grandes. Hoy no. Las herramientas existen, son accesibles y funcionan —lo que falta es alguien que sepa usarlas y las adapte a cada negocio.

Eso es exactamente lo que hago.

Tengo formación en Informática, Telecomunicaciones y un máster en Inteligencia Artificial. Profesionalmente trabajo en Telefónica Tech en el área de Protección del Riesgo Digital (DRP), lo que me da una visión técnica poco habitual sobre cómo los negocios están expuestos en internet y qué señales dejan sin darse cuenta. Esa perspectiva informa directamente cómo analizo la presencia digital de cada cliente. Trabajo como autónomo, sin intermediarios: quien te hace la propuesta es quien ejecuta el trabajo. Y porque no tengo la estructura de costes de una agencia, puedo ofrecer soluciones que antes solo estaban al alcance de quien podía pagar equipos enteros —a precios que tienen sentido para un negocio local.

Mi zona habitual es el norte de Madrid: San Agustín de Guadalix, Alcobendas, San Sebastián de los Reyes, El Molar, Paracuellos de Jarama y alrededores.

Me especializo en negocios locales que no están en internet, que están mal posicionados, o que pierden clientes y tiempo por falta de procesos básicos: hostelería, clínicas, comercios, servicios de barrio. Sitios donde los cambios se notan rápido y donde no hace falta un departamento de marketing, sino alguien que entienda el problema y lo resuelva.

Trabajo con las tecnologías que se usan hoy en las empresas que más crecen en internet —las mismas que antes solo estaban al alcance de proyectos con grandes presupuestos. Eso significa que no hay límite técnico para lo que se puede montar; la pregunta siempre es qué tiene sentido para el negocio concreto.

---

---

## SECCIÓN A — PARA CLIENTES

### El problema tiene nombre: el Dueño Orquesta

Tienes un negocio que funciona, pero tú llevas todo: atiendes el teléfono, gestionas los pedidos, respondes WhatsApps a las once de la noche y encima tienes que pensar en cómo conseguir más clientes. Eres el director, el músico y el afinador a la vez.

El resultado es siempre el mismo: **trabajas más horas que nadie, pero el negocio no crece al ritmo que debería. No porque trabajes mal, sino porque nadie puede crecer mientras apaga fuegos todo el día.**

---

### Lo que hago

Analizo tu negocio tal y como está hoy: cómo te encuentran los clientes, cómo les atiendes, dónde se pierden oportunidades. Y a partir de ahí, montamos juntos lo que falta —sin tecnología innecesaria, sin proyectos eternos, sin páginas web bonitas que no sirven para nada.

El objetivo es uno: **que te lleguen más clientes y que pierdas menos tiempo gestionando los que ya tienes.**

Agenda organizada, bandeja de entrada que no se desborda, respuestas automáticas para las preguntas de siempre, presencia en Google cuando alguien busca lo que tú ofreces. Herramientas concretas que se notan en la factura al mes siguiente.
...
### Las 3 etapas del trabajo

#### Etapa 1 — Diagnóstico: ver dónde se escapa el dinero

Antes de mover nada, miramos juntos cómo está el negocio hoy. Cómo te encuentran los clientes (o cómo no te encuentran), qué procesos te roban más tiempo y dónde hay oportunidades claras sin explotar.

Sin papeles, sin presentaciones. Solo ver la realidad con claridad.

**Lo que notas:** en la primera semana ya tienes un mapa claro de por qué no crece lo que debería crecer.

---

#### Etapa 2 — Ejecución: montamos lo que hace falta

Aquí está el trabajo concreto. Según lo que hayamos detectado: optimizamos tu ficha de Google, montamos la agenda online, ordenamos el buzón, mejoramos lo que tienes o construimos lo que falta.

Nada genérico. Solo lo que tiene sentido para tu negocio y tus clientes.

**Lo que notas:** en las primeras semanas el teléfono empieza a sonar más. Las consultas entran más ordenadas. Tienes menos que gestionar tú a mano.

---

#### Etapa 3 — Gasolina al fuego: ahora sí, a crecer

Con la base puesta, tiene sentido ir a por más. Más visibilidad, más canales, más automatización. Esta etapa es la que más gusta porque los resultados se ven directamente en la cuenta.

**Lo que notas:** tomas decisiones de crecimiento sin vértigo porque tienes la estructura para responder.

---

### Proyectos realizados

#### Webs y plataformas para clientes

**Hierros Merle — Sector Industrial**
Empresa familiar desde 1993 sin presencia digital útil. Renovación completa orientada a SEO local. Resultado: **+1.500 visitas orgánicas al mes en 6 días**. Mejora notable en la calidad de los presupuestos recibidos.
Stack: Next.js 15, React 19, Tailwind CSS 4 · [merle.es](https://merle.es)

---

**Fotografía Aérea Madrid — Servicios de Drones**
Web posicionada en búsquedas locales de fotografía aérea profesional HDR y 4K en Madrid. Drones certificados AESA. Orientada a captación de presupuestos.
Stack: Next.js, Vercel · [fotografiaaereamadrid.vercel.app](https://fotografiaaereamadrid.vercel.app)

---

**Metal Line — Ingeniería de Precisión**
Plataforma corporativa para empresa de transformación metálica. Enfoque en credibilidad industrial y posicionamiento SEO sectorial.
Stack: WordPress, Custom CSS, SEO · [metal-line.es](https://metal-line.es)

---

**Café & Tortilla Montes — Hostelería Local**
Demo operativa que sustituye la web de presentación por una herramienta real: carta digital + sistema de encargos automatizado vía WhatsApp. **Digitalización funcional en 7 días.**
Stack: Next.js, Tailwind CSS, Vercel · [montes.vercel.app](https://montes.vercel.app)

---

**Lolo Transportes — Logística Inteligente**
Plataforma de transporte de carga con comparación de precios en tiempo real. Ahorro de hasta un 40% aprovechando rutas de retorno. Cálculo automático de tarifas según origen, destino y tipo de carga.
Stack: Next.js, Tailwind CSS, Vercel · [lt-wheat.vercel.app](https://lt-wheat.vercel.app)
...
No te vendo "presencia digital". Te vendo esto:

- **Que te encuentren antes que a tu competencia.**
- **Que ningún cliente potencial se pierda por no contestar a tiempo.**
- **Que recuperes horas que ahora malgastas en gestiones que puede hacer un sistema.**

---

### Cómo funciona el precio

No hay tarifas cerradas porque cada negocio es un punto de partida distinto. Lo que sí puedo decirte:

- Un módulo concreto (agenda, Google Business, buzón, landing) parte de **150 € + IVA.**
- Una web completa con SEO local desde **449 € + IVA**, según lo que necesite el proyecto.
- Si son varias cosas juntas, se negocia un pack más ajustado.
- El pago se divide: 50% al arrancar, 50% a la entrega.
- Sin cuotas mensuales. Sin letra pequeña.

La primera conversación es gratuita. Vemos lo que tienes, lo que falta y lo que tiene sentido. Si no encaja, te lo digo sin rodeos.

---

---

## SECCIÓN B — PARA COLABORADORES

### Sobre Alex Merle

Tener una web posicionada, un sistema de reservas automático o un proceso de captación bien montado ya no es exclusivo de empresas grandes. Las herramientas existen y funcionan —lo que falta es alguien con el conocimiento para usarlas bien y adaptarlas a cada caso.

Tengo formación en Informática, Telecomunicaciones y un máster en Inteligencia Artificial. Profesionalmente trabajo en Telefónica Tech en el área de Protección del Riesgo Digital (DRP), lo que me da una perspectiva técnica sólida sobre cómo los negocios aparecen —y se exponen— en internet. Trabajo como autónomo, sin estructura de agencia: lo que me permite ofrecer soluciones con la misma calidad técnica que una empresa grande, a precios que tienen sentido para un negocio local. Siempre dentro de la legislación española.

Mi zona habitual es el norte de Madrid (San Agustín de Guadalix, Alcobendas, San Sebastián de los Reyes, El Molar, Paracuellos…). Si tú operas en otra zona, no es un problema: tú llevas los clientes de tu área, gestionas la relación directa con ellos, recabas la información que necesito y me la trasladas. Yo me encargo de la parte técnica y de la propuesta de solución. Tú eres quien lleva el proceso al cliente y quien acompaña hasta que esté satisfecho. La geografía no es una barrera siempre que haya alguien de confianza sobre el terreno.

Me especializo en negocios locales que aún no están en internet o que están mal posicionados: hostelería, clínicas, servicios de barrio, comercios. Sitios donde hay margen real de mejora y donde los cambios se notan rápido.

---

### Stack tecnológico — con qué trabajo

Esto es relevante para ti como colaborador: saber qué puedo y qué no puedo montar define qué proyectos puedes traer con confianza.
...
**Lo que esto significa para ti como colaborador:** si un cliente te dice que tiene WordPress y quiere mejorarla, puedo. Si quiere una web nueva moderna con reservas y automatizaciones, puedo. Si tiene algo montado hace diez años y quiere saber por qué no aparece en Google, puedo diagnosticarlo. No hay que filtrar proyectos por limitación técnica —hay que filtrarlos por si tiene sentido económico para el cliente.

---

### No eres un captador de leads. Eres un socio.

Esto no va de que traigas clientes y yo me encargue del resto. Va de algo diferente: **tú llevas a tus propios clientes, a tu manera, con tu relación.** Yo soy el apoyo técnico detrás. El que detecta qué hace falta, lo monta y entrega resultados que tú puedes firmar con tu nombre.

Si ya tienes contactos entre autónomos, negocios locales o pymes, tienes todo lo que necesitas para empezar. No hace falta saber de tecnología. Solo necesitas conocer a tu cliente y saber escuchar dónde le aprieta el zapato.

---

### Cómo funciona la colaboración

Hay dos niveles según tu implicación:

**Nivel 1 — Tú traes el contacto, yo cierro y ejecuto**
Identificas a alguien que encaje, abres la conversación y me lo presentas. Yo hago el diagnóstico, preparo la propuesta y llevo el proyecto. Tú cobras una comisión de entre el **10 y el 15%** sobre el total facturado.

**Nivel 2 — Tú llevas al cliente de principio a fin**
Conoces el negocio, detectas las necesidades, acuerdas con el cliente qué hacer y yo lo ejecuto técnicamente. La relación comercial es tuya, yo soy el equipo técnico.
...
El acuerdo concreto se cierra antes de cada proyecto, nunca a posteriori. Sin sorpresas.

No hay letra pequeña. Lo que se acuerda por escrito antes de empezar es lo que se cobra.

---

### Pitches por perfil de colaborador

No hay un único guion. Cada colaborador tiene su propio punto de partida, su red y su forma de hablar con los clientes. Aquí tienes los argumentos adaptados a los perfiles más habituales.

---

#### Si trabajas o tienes conocimientos de SEO
...
#### Si trabajas o tienes conocimientos de redes sociales
...
#### Si tienes red de contactos en hostelería
...
#### Si tienes contactos en clínicas, consultas o centros de salud
...
#### Si eres consultor, asesor o gestor de empresas
...
#### Si no tienes perfil técnico pero sí red de contactos locales
...
### Los microservicios: lo que se puede montar según lo que necesite el cliente

La clave es no vender lo que ya tienen, sino mejorar lo que les falta —o revisar lo que creen que funciona y en realidad no les da resultados.
...
### Por qué este modelo funciona para el colaborador

**1. No necesitas saber de tecnología**
Tú describes el problema que ha detectado el cliente. Yo traduzco la solución y la ejecuto.

**2. Resultados rápidos que refuerzan tu credibilidad**
Las primeras mejoras se notan en días, no en meses. Una agenda online, una ficha de Google en condiciones, un buzón que no se desborda. Tu cliente te lo agradece a ti porque tú abriste la puerta.

**3. Tu cartera actual ya es suficiente para empezar**
No hace falta salir a buscar desconocidos. Probablemente tienes ahora mismo 3 o 4 contactos que se beneficiarían de alguno de estos servicios y no lo saben.

**4. El upsell es natural**
Un cliente que empieza con la revisión de su Google Business puede acabar con agenda, buzón y landing mejorada. No porque se lo vendas, sino porque él mismo pide más cuando ve resultados.

**5. Comisiones desde el primer proyecto**
No hay mínimos, no hay volúmenes. El primer cliente que traes ya genera comisión.
...
### Cómo abrir la conversación (sin parecer un vendedor)
...
### Lo que necesitas de tu lado para empezar

1. Piensa en 2 o 3 negocios de tu entorno que no aparezcan bien online o que perdan tiempo en gestiones manuales.
2. Abre la conversación de forma natural.
3. Si hay interés, contáctame y valoramos juntos el caso.

Nada de catálogos que memorizar. Nada de presentaciones formales. Una conversación honesta es suficiente.
...
## NOTAS DE IMPLEMENTACIÓN (uso interno)
...
**Ruta propuesta:** `/dossier/[slug-secreto]`
Ejemplo: `/dossier/colaboradores-2025` o `/dossier/am-privado`
...
- Layout en columna única centrada, ancho máximo ~794px (A4 a 96dpi).
- Tipografía legible en impresión: sans-serif, tamaño mínimo 13px en cuerpo.
- Fondo blanco o muy claro para que la impresión no gaste tinta.
- Separadores de sección visibles para orientar al lector al hojear.
- Las tablas deben romperse correctamente en salto de página (`page-break-inside: avoid`).
...
Al ser una ruta con slug dinámico, añadir `generateStaticParams()` en `src/app/dossier/[slug]/page.tsx` devolviendo el slug correcto. No requiere servidor.

```ts
export function generateStaticParams() {
  return [{ slug: "colaboradores-2025" }];
}
```
