...
const pitches = [
  {
    ...
    opener: "¿Sabes cuántas búsquedas hay en Google cada mes de gente buscando lo que tú ofreces en tu zona?",
  },
  {
  ...
  },
  {
    ...
    opener: "¿Cuántas veces al día coges el teléfono para confirmar reservas o encargos que podrían gestionarse solos?",
  },
  {
  ...
  },
  {
    ...
    opener: "¿Alguno de tus clientes te ha preguntado alguna vez por qué no le llegan más clientes?",
  },
  {
...
const microservices = [
  {
    ...
    color: "brand-blue",
    rows: [
      { has: "Nada en internet", offer: "Ficha de Google Business + web de aterrizaje", price: "Desde 449 €" },
      { has: "Google Business sin optimizar", offer: "Revisión y puesta a punto: fotos, categorías, reseñas", price: "Desde 150 €" },
      { has: "Google Business activo", offer: "Análisis de rendimiento + estrategia de reseñas", price: "Desde 150 €" },
      { has: "Web propia sin resultados", offer: "Auditoría SEO + informe de mejoras concretas", price: "Desde 150 €" },
      { has: "Redes activas pero sin web", offer: "Landing page de captación enlazada desde perfil", price: "Desde 150 €" },
    ],
  },
  {
    ...
    color: "brand-teal",
    rows: [
      { has: "Email caótico o sin estructura", offer: "Buzón centralizado con etiquetas y flujo de respuesta", price: "Desde 150 €" },
      { has: "Consultas repetidas por WhatsApp", offer: "Respuestas automáticas para las preguntas frecuentes", price: "Desde 150 €" },
      { has: "Reservas y citas por teléfono", offer: "Sistema de agenda online (el cliente reserva solo)", price: "Desde 150 €" },
      { has: "Clínica que gestiona citas en papel", offer: "Sistema de reservas online con confirmación automática", price: "Desde 299 €" },
    ],
  },
  {
    ...
    color: "brand-blue",
    rows: [
      { has: "Mucho tiempo en tareas repetitivas", offer: "Mapeo de los 3 procesos que más tiempo roban + automatización", price: "Desde 150 €" },
      { has: "Info dispersa entre WhatsApp, email y papel", offer: "Sistema centralizado básico", price: "Desde 150 €" },
    ],
  },
];
...
const marginTable = [
  { type: "Auditoría, revisión Google Business, buzón, agenda", margin: "Alto — ejecución ligera", commission: "Hasta el 50% del margen" },
  { type: "Landing page o web sencilla", margin: "Medio — más horas de producción", commission: "25–35% del margen" },
  { type: "Web completa con integraciones", margin: "Bajo — proyecto intensivo", commission: "15–25% del margen" },
  { type: "Packs combinados", margin: "Variable", commission: "Se acuerda antes de arrancar" },
];

const idealClient = [
  { yes: "Negocio local: bar, restaurante, clínica, comercio", no: "Grandes empresas con marketing propio" },
  { yes: "El dueño gestiona él mismo su comunicación", no: "Negocios con todo externalizado y funcionando" },
  { yes: "No aparece en Google o aparece mal", no: "Quien busca soluciones mágicas sin cambiar nada" },
  { yes: "Usa papel o WhatsApp para gestionar citas", no: "El que ya tiene informático de confianza para todo" },
  { yes: "Factura pero sin presencia online consistente", no: "El que no tiene tiempo ni ganas de implicarse" },
];
      ...
      <main className="min-h-screen pb-32">
            ...
            <div className="glass-card p-10 bg-[#080808]/40 flex flex-col md:flex-row gap-10 items-start">
              ...
              <div className="space-y-4">
                ...
                <p className="text-white/55 text-sm leading-relaxed font-medium print-muted">
                  ...
                  Trabajo en Telefónica Tech en el área de Protección del Riesgo Digital (DRP) —
                  lo que me da una perspectiva técnica sólida sobre cómo los negocios aparecen y
                  se exponen en internet. Sin estructura de agencia: misma calidad técnica, precios
                  que tienen sentido para un negocio local.
                </p>
                <p className="text-white/55 text-sm leading-relaxed font-medium print-muted">
                  Zona habitual: norte de Madrid. Si tú operas en otra zona, no es un problema:
                  tú llevas los clientes de tu área, gestionas la relación y me trasladas las
        ...
        <section id="roles" className="py-16 px-6 print-break scroll-mt-24">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              {[
                { icon: Users, label: "Tu rol", desc: "Conoces al cliente, detectas la necesidad, abres la conversación y mantienes la relación.", color: "brand-teal" },
                { icon: Wrench, label: "Mi rol", desc: "Diagnóstico técnico, propuesta de solución, ejecución y soporte. Sin que tengas que entender cómo funciona.", color: "brand-blue" },
                { icon: TrendingUp, label: "El resultado", desc: "El cliente recibe resultados reales. Tú te llevas la comisión y la credibilidad. Yo ejecuto.", color: "brand-teal" },
              ].map((item) => (
                <div key={item.label} className="glass-card p-7 bg-[#080808]/40 flex flex-col gap-4">
                  <div className={`w-11 h-11 rounded-xl flex items-center justify-center ${item.color === "brand-blue" ? "bg-brand-blue/10 border border-brand-blue/20" : "bg-brand-teal/10 border border-brand-teal/20"}`}>
                    <item.icon size={18} className={item.color === "brand-blue" ? "text-brand-blue" : "text-brand-teal"} />
                  </div>
                  <div>
                    <span className={`text-[10px] font-black uppercase tracking-widest block mb-1 ${item.color === "brand-blue" ? "text-brand-blue" : "text-brand-teal"}`}>
                      {item.label}
                    </span>
                    <p className="text-white/55 text-sm leading-relaxed font-medium print-muted">{item.desc}</p>
                  </div>
                </div>
              ))}
            </div>
        ...
        <section id="comisiones" className="py-16 px-6 print-break scroll-mt-24">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              {commissions.map((c) => (
                <div key={c.level} className={`glass-card p-8 bg-[#080808]/40 flex flex-col gap-4 ${c.color === "brand-teal" ? "border-brand-teal/20" : "border-brand-blue/20"}`}>
                  <span className={`text-[10px] font-black uppercase tracking-widest ${c.color === "brand-teal" ? "text-brand-teal" : "text-brand-blue"}`}>
                    {c.level}
                  </span>
                  <h3 className="text-xl font-black tracking-tight leading-snug">{c.title}</h3>
                  <div>
                    <span className={`text-5xl font-black tracking-tighter leading-none ${c.color === "brand-teal" ? "text-brand-teal" : "text-brand-blue"}`}>
                      {c.pct}
                    </span>
                  ...
                  <p className="text-white/45 text-sm leading-relaxed font-medium print-muted">{c.desc}</p>
                </div>
              ))}
            </div>

            {/* Tabla de márgenes */}
            <div className="glass-card bg-[#080808]/40 overflow-hidden" style={{ borderRadius: "1rem" }}>
        ...
        <section id="pitches" className="py-16 px-6 print-break scroll-mt-24">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-white/45 text-base font-medium mb-10 print-muted">
              No hay un único guion. Cada colaborador tiene su punto de partida. Aquí tienes los argumentos adaptados.
            </p>
            <div className="space-y-6">
              {pitches.map((p, i) => (
                <div key={i} className="glass-card p-8 bg-[#080808]/40">
                  <span className={`text-[10px] font-black uppercase tracking-widest block mb-3 ${i % 2 === 0 ? "text-brand-blue" : "text-brand-teal"}`}>
                    {p.profile}
                  </span>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-5">
                    <div>
                      <span className="text-[9px] font-black uppercase tracking-widest text-white/30 block mb-1.5 print-muted">Tú aportas</span>
                      <p className="text-white/55 text-xs leading-relaxed font-medium print-muted">{p.you}</p>
                    </div>
                    <div>
                      <span className="text-[9px] font-black uppercase tracking-widest text-white/30 block mb-1.5 print-muted">Yo aporto</span>
                      <p className="text-white/55 text-xs leading-relaxed font-medium print-muted">{p.me}</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-2 border-t border-white/5 pt-4">
                    <span className="text-[9px] font-black uppercase tracking-widest text-white/25 shrink-0 mt-0.5 print-muted">Pregunta de apertura</span>
                    <p className={`text-xs font-bold italic ${i % 2 === 0 ? "text-brand-blue/80" : "text-brand-teal/80"}`}>
        ...
        <section id="catalogo" className="py-16 px-6 print-break scroll-mt-24">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-white/45 text-base font-medium mb-10 print-muted">
              La clave es no vender lo que ya tienen — sino lo que les falta o lo que no les funciona bien.
            </p>
            <div className="space-y-6">
              {microservices.map((cat) => (
                <div key={cat.category} className="glass-card bg-[#080808]/40 overflow-hidden" style={{ borderRadius: "1rem" }}>
                  <div className={`px-7 py-4 border-b border-white/5 flex items-center gap-3`}>
                    <span className={`w-2 h-2 rounded-full ${cat.color === "brand-blue" ? "bg-brand-blue" : "bg-brand-teal"}`} />
                  ...
                  <div className="divide-y divide-white/5">
                    {cat.rows.map((row) => (
                      <div key={row.has} className="grid grid-cols-1 md:grid-cols-3 gap-0">
                        <div className="px-7 py-4 md:border-r border-white/5">
                          <span className="text-[9px] font-black uppercase tracking-widest text-white/25 block mb-1 md:hidden print-muted">El cliente tiene</span>
                          <p className="text-xs text-white/45 font-medium print-muted">{row.has}</p>
                        </div>
                        <div className="px-7 py-4 md:border-r border-white/5">
                          <span className="text-[9px] font-black uppercase tracking-widest text-white/25 block mb-1 md:hidden print-muted">Qué ofrecer</span>
                          <p className="text-sm font-semibold text-white/80 print-white">{row.offer}</p>
                        </div>
                        <div className="px-7 py-4 flex items-center">
                          <span className={`text-xs font-black ${cat.color === "brand-blue" ? "text-brand-blue" : "text-brand-teal"}`}>
                            {row.price}
                          </span>
                        </div>
                      </div>
            ...
            <p className="text-white/30 text-xs mt-4 font-medium print-muted">
              Los módulos combinados se negocian en pack. La tarifa base de producción es 50 €/h + IVA.
            </p>
          </div>
        </section>
            ...
            <div className="glass-card bg-[#080808]/40 overflow-hidden" style={{ borderRadius: "1rem" }}>
              <div className="grid grid-cols-2 border-b border-white/5">
                <div className="px-7 py-4 border-r border-white/5">
                  <span className="text-[9px] font-black uppercase tracking-widest text-brand-teal print-white">Perfil que convierte</span>
                </div>
                <div className="px-7 py-4">
                  <span className="text-[9px] font-black uppercase tracking-widest text-white/30 print-muted">No es para nosotros</span>
                </div>
              </div>
              <div className="divide-y divide-white/5">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="glass-card p-10 bg-[#080808]/40 text-center space-y-6">
              ...
              <h2 className="text-4xl md:text-5xl font-black tracking-tighter">
                ...
                <span className="gradient-text">es suficiente.</span>
              </h2>
              <div className="max-w-xl mx-auto space-y-3 text-left">
                {[
                  ...
                  <div key={i} className="flex items-start gap-4">
                    ...
                    <p className="text-white/55 text-sm font-medium leading-relaxed print-muted">{step}</p>
                  </div>
                ))}
              </div>
              <div className="flex flex-wrap justify-center gap-4 pt-4">
                <a href="mailto:alex@merle.es" className="btn-primary px-7 py-3 print-hide">
