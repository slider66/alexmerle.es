      ...
      <div className="max-w-3xl mx-auto prose prose-invert prose-sm">
        ...
        <section className="mb-10 space-y-3">
          ...
          <p className="text-white/50 leading-relaxed">
            ...
            Sociedad de la Información y del Comercio Electrónico (LSSI-CE), se informa:
          </p>
          <ul className="text-white/50 space-y-1 list-none pl-0">
            <li>
              <span className="text-white/30 text-xs uppercase tracking-widest">Titular:</span>{" "}
            ...
            <li>
              <span className="text-white/30 text-xs uppercase tracking-widest">Teléfono:</span> +34
              600 367 217
            </li>
            <li>
        ...
        <section className="mb-10 space-y-3">
          ...
          <p className="text-white/50 leading-relaxed">
            Todos los contenidos del sitio web (textos, imágenes, diseño, código fuente y demás
            elementos) son titularidad de Alejandro Merle Sánchez o de terceros que han autorizado
            su uso, y están protegidos por la legislación española e internacional en materia de
            propiedad intelectual e industrial.
          </p>
          <p className="text-white/50 leading-relaxed">
            Queda prohibida la reproducción, distribución, comunicación pública o transformación de
            cualquier contenido sin autorización expresa y por escrito del titular.
          </p>
        </section>
        ...
        <section className="mb-10 space-y-3">
          ...
          <p className="text-white/50 leading-relaxed">
            El titular no garantiza la ausencia de errores en los contenidos ni su actualización
            permanente. No se hace responsable de los daños derivados del uso del sitio, de la
            imposibilidad de acceso o de la presencia de virus u otros elementos lesivos.
          </p>
        </section>
        ...
        <section className="mb-10 space-y-3">
          ...
          <p className="text-white/50 leading-relaxed">
            ...
            derivada del uso del sitio, las partes se someten a los juzgados y tribunales del
            domicilio del titular, salvo que la normativa vigente establezca otro fuero imperativo.
          </p>
        </section>
