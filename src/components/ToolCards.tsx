  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      {repos.map((repo, index) => (
        <BlurReveal key={repo.id} delay={(index % 3) * 0.06} className="h-full">
          <div className="glass-card group flex flex-col h-full bg-[#080808]/40 border-white/5 hover:border-brand-teal/25 transition-colors duration-500 p-8">
            {/* Header */}
