...
const WA_URL =
  "https://wa.me/34600367217?text=" +
  encodeURIComponent("Hola Alejandro, te escribo desde alexmerle.es. Me gustaría saber más sobre tus servicios.");

export function HeroCtas() {
  const track = (cta: "primary" | "secondary" | "whatsapp") => {
  ...
  return (
    ...
    >
      ...
      <a
        ...
        className="w-full sm:w-auto px-10 py-5 bg-[#25D366]/10 border border-[#25D366]/30 text-[#25D366] font-black uppercase text-xs tracking-widest rounded-full hover:bg-[#25D366]/20 transition-all active:scale-95 flex items-center justify-center gap-2"
